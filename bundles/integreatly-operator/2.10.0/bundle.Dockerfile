...
COPY bundles/integreatly-operator/2.10.0/manifests /manifests/
COPY bundles/integreatly-operator/2.10.0/metadata /metadata/
COPY bundles/integreatly-operator/2.10.0/tests/scorecard /tests/scorecard/
