...
COPY bundles/managed-api-service/2.10.0/manifests /manifests/
COPY bundles/managed-api-service/2.10.0/metadata /metadata/
COPY bundles/managed-api-service/2.10.0/tests/scorecard /tests/scorecard/
