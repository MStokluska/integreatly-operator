...
manifest_compare() {
    ...
    FILE_NAME="prodsec-master-from-branch-manifest.txt"
    RHOAM_MASTER_FROM_BRANCH="prodsec-manifests/rhoam-master-from-branch-manifest.txt"
...
"master")
    RHOAM_VERSION="master"
    FILE_NAME="prodsec-master-manifest.txt"
    manifest_generate
    exit 0
    ;;
"compare")
